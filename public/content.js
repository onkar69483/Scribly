(function () {
  ...
  function createAnnotationButton() {
    ...
    chrome.storage.local.get({ guideShown: false }, (data) => {
      if (!data.guideShown && !guideShown) {
        showGuidePopup(button);
      }
    });
  }
  ...
  function showGuidePopup(button) {
    ...
    guide.innerHTML = `
      <div class="guide-content">
        <div class="guide-header">
          ...
          <span class="guide-title">Take Notes While Watching!</span>
        </div>
        <div class="guide-text">
          Click this button to add timestamped notes to your videos. Perfect for studying, research, or marking favorite moments!
        </div>
    ...
    closeButton.onclick = () => {
      guide.classList.add("guide-fade-out");
      setTimeout(() => {
        guide.remove();
